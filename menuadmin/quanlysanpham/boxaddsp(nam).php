...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['themsanpham'])) {
    ...
    if (move_uploaded_file($anh_tmp, $target_file)) {
        ...
        $sql_them = "INSERT INTO sanpham (ten, noidung, nhacungcap, giaban, giavon, soluong, luongmua, anh, danhmuc, hang, manhinh, chip, ram, camera, bonhotrong, pin) 
                     VALUES ('$ten', '$noidung', '$nhacungcap', '$giaban', '$giavon', '$soluong', '$luongmua', '$anh', '$danhmuc','$hang','$manhinh','$chip','$ram','$camera','$bonhotrong','$pin')";
