...
<body>
	...
	<div class="container">
		 <?php 	
			   ...
			   $sql = "INSERT INTO hangsanpham (tenhang, xuatxu, mota, namthanhlap) VALUES('$tenhang', '$xuatxu', '$mota', '$namthanhlap')";
			...
			?>
        <h1 align="center">Thêm Hãng Điện Thoại</h1>
...
-->
            ...
            <div class="form-group">
                ...
                <input type="number" id="namthanhlap" name="namthanhlap" required>
            </div>
            <div class="form-actions">
                <button type="submit" name = "them" id = "them">Lưu</button>
                <button type="reset" name = "reset" id = "reset">Làm mới</button>
            </div>
        </form>
    </div>
   <?php echo $bot;?>
